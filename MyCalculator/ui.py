...
#   Define buttons
button_0 = Button(number_container_r4, text="0", height=1, width=3, command=lambda:number_callback(0))
...
button_undo = Button(misc_container_r1, text="undo", height=1, width=3, command=lambda:operator_callback("undo"))
button_clear = Button(misc_container_r1, text="clear", height=1, width=3, command=lambda:operator_callback("clear"))
button_Lparentheses = Button(misc_container_r2, text="(", height=1, width=3, command=lambda:operator_callback("("))
button_Rparentheses = Button(misc_container_r2, text=")", height=1, width=3, command=lambda:operator_callback(")"))
button_square = Button(misc_container_r3, text="sq", height=1, width=3, command=lambda:operator_callback("sq"))
button_root = Button(misc_container_r3, text="sqrt", height=1, width=3, command=lambda:operator_callback("sqrt"))
button_equal = Button(misc_container_r4, text="=", height=1, width=10, command=lambda:operator_callback("="))
